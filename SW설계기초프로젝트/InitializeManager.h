...
private:
    ...
    static void MapInit() {
        ...
        MapManager::createMap("S6_P_MAP_01", TYPE_PUZZLE, "src\\S0_MAP.png", "src\\S0_MAP_INFO.png");
        MapManager::createMap("S6_P_MAP_02", TYPE_PUZZLE, "src\\S6_P_MAP_01.png", "src\\S6_P_MAP_01_INFO_01.png");
    ...
    static void StageInit(EventDispatcher* eventDispathcer) {
        ...
        StageManager::addMap(6, MapManager::getMap("S6_P_MAP_02"));
        StageManager::addMap(6, MapManager::getMap("S6_J_MAP_01"));

        StageManager::setDoorID(6, "S6_P_MAP_01", MAP_EXIT, "S6_P_MAP_02");
        StageManager::setDoorID(6, "S6_P_MAP_02", MAP_EXIT, "S6_J_MAP_01");
        StageManager::setDoorID(6, "S6_J_MAP_01", MAP_EXIT, "EXIT");

        StageManager::setPuzzleId(6, "S6_P_MAP_02", PUZZLE_OBJ_01, "S6_M1_PZ_01");
        StageManager::setPuzzleId(6, "S6_P_MAP_02", PUZZLE_OBJ_02, "S6_M1_PZ_02");
        ...
        MapManager::setMapASCII("S6_P_MAP_02");
